...
std::unordered_set<int> Ransac(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, int maxIterations, float distanceTol)
{
	...
	while(maxIterations--)
	{
		// randomly pick two points
                                                            // std::unordered_set은 std::set과 달리 자동정렬을 하지 않아 빠른 장점이 있음 <int>는 set을 정수로 저장하겠다는 것을 의미  
...
int main () 
{
	...
	std::unordered_set<int> inliers = Ransac(cloud, 1000, 1.0);  // std::unordered_set은 std::set과 달리 자동정렬을 하지 않아 빠른 장점이 있음 <int>는 set을 정수로 저장하겠다는 것을 의미 
